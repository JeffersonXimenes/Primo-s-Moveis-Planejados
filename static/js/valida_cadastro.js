function valida_cadastro() {
    ...
    var iProcedencia = document.getElementById("iProcedencia").value;
    ...
    // Campo não necessário utilizar validação de preenchimento
    else if (iProcedencia.length == "") {
        alert("Preencha o campo Como conheceu a Primos Movéis!")
        return false;
