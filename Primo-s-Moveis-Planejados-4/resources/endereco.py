...
class Enderecos(Resource):
    ...
    atributos.add_argument('nCep', type=str, required=True, help="O campo 'cep' não pode ser em branco.")
    atributos.add_argument('iEndereco', type=str, required=True, help="O campo 'endereco' não pode ser em branco.")
    atributos.add_argument('iComplemento', type=str, required=True, help="O campo 'complemento' não pode ser em branco.")
    atributos.add_argument('iBairro', type=str, required=True, help="O campo 'bairro' não pode ser em branco.")
    atributos.add_argument('iUf', type=str, required=True, help="O campo 'uf' não pode ser em branco.")
