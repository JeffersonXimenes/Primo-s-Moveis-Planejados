...
class EnderecoModel(banco.Model):
    ...
    nCep = banco.Column(banco.String(9), nullable=False)
    ...
    def __init__(self, cEndereco, cCliente, nCep, iEndereco, numero ,iComplemento,iBairro,cUf):
    ...
    def update_endereco(self, cCliente, nCep, iEndereco,numero, iComplemento,iBairro,cUf):
        self.cCliente = cCliente
        self.nCep = nCep
        self.iEndereco = iEndereco
        self.numero = numero
