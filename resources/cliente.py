...
class Clientes(Resource):
    ...
    def post(self,dados):
        ...
        if ClienteModel.find_cliente(id):
            ...
            #return {"mensagem": "Cliente id '{}' já existe.".format(id)}, 400 #Bad Request
...
class Cliente(Resource):
    ...
    atributos.add_argument('iProcedencia', type=str, required=True, help="O campo 'iProcedencia' não pode ser em branco.") 
